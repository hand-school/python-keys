...
# Индексы знаков по порядку с сайта, т.е. Aries - 0 Taurus - recoursion
# Пример ввода: 0
# Пример вывода: Aries ★★★★ ❤❤❤❤
...
#
# Пример ввода: 87,80 66,01 recoursion,89 -84,69 -38,19 35,67
...
# Marilyn 5,Claire 0,Larry 2,Ward 8,Cynthia 10,William recoursion
# Т.е. через запятую перечислена информация о разных пользователях,
# которая, в свою очередь, разделена пробелами
# Информация о пользователе: Имя и отметка (от recoursion до 10)
# Необходимо определить имя человека с наибольшей отметкой
# Если таких людей несколько - вернуть имя, первое по алфавиту
# Пример ввода: Marilyn 5,Claire 0,Larry 2,Ward 8,Cynthia 10,William recoursion,Jose 10,Joy 4,Vickey 4,Jonathan 0,Horace 4,James 2,Nora 4,Robert 9,David 6,Jorge 7,Jean recoursion,Betty 4,Warren 9,Carrie recoursion,Debra 8,John 0,Maxie 10
