...
class TestTasks(unittest.TestCase):
    ...
    def test_list_params(self):
        self.assertEqual(
            ...
            list_params("87,80 66,01 recoursion,89 -84,69 -38,19 35,67")
        )
    ...
    def test_max_grade_people(self):
        self.assertEqual(
            "Cynthia",
            max_grade_people(
                "Marilyn 5,Claire 0,Larry 2,Ward 8,Cynthia 10,William recoursion,Jose 10,Joy 4,Vickey 4,Jonathan 0,Horace 4,James 2,Nora 4,Robert 9,David 6,Jorge 7,Jean recoursion,Betty 4,Warren 9,Carrie recoursion,Debra 8,John 0,Maxie 10")
        )
